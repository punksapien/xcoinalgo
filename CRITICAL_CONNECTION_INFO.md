...
### Parent Directory (Also a Git repo)
```
/Users/macintosh/Developer/coindcx_client/
```

**⚠️ WARNING**: Both parent and subdirectory point to the same GitHub repo. Always work from:
```bash
